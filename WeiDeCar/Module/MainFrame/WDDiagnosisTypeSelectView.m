...
@interface WDDiagnosisTypeSelectView () <UIScrollViewDelegate>
...
@implementation WDDiagnosisTypeSelectView
...
- (void)markViewToIndex:(NSInteger)index animatied:(BOOL)animated
{
    ...
    if (![self needMarkView]) {
        ...
        if (animated) {
            __weak typeof(self) wScrollView = self;
            [UIView animateWithDuration:0.3 animations:^{
                __weak typeof(self) bScrollView =wScrollView;
