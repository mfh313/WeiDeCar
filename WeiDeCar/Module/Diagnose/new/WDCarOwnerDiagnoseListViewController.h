...
@interface WDCarOwnerDiagnoseListViewController : WDDiagnoseListBaseViewController <WDDiagnosisMainAddViewDelegate>
{
    WDDiagnosisMainAddView *m_createDiagnoseView;
}
