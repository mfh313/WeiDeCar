...
NSInteger const WDDiagnoseStatus_CAR_OWNER_RECONFIRMED_AFTER_EXPERT_DIAGNOSED = 35;  //专家复诊后，车主再次确认
NSInteger const WDDiagnoseStatus_PAYMENT_SUCCESS = 40;  //支付成功
NSInteger const WDDiagnoseStatus_PAYMENT_FAILURE = 45;  //支付失败
NSInteger const WDDiagnoseStatus_QA_SUCCESS = 50;  //质检合格，待评价
NSInteger const WDDiagnoseStatus_FINISHED = 80;  //完成
